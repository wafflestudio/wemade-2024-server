...
urlpatterns = [
    ...
    path(
        "edit/",
        EditListAPIView.as_view(),
        name="edit-list"
    ),
    # Subteam들 정보 불러오기
    path(
        "edit/team/<int:t_id>/",
        TeamEditListAPIView.as_view(),
        name="team-edit-list"
    ),
    ...
    path(
        "roles/<int:p_id>/",
        RoleListDetailAPIView.as_view(),
        name="role-get"
    ),
    # 특정한 사람의 role 생성 (부서 이동/발령)
    path(
        "roles/<int:p_id>/create/",
    ...
    path(
        "corp/create/",
        CorpCreateAPIView.as_view(),
        name="corp-create"
    ),
    # 모든 Corporation List
    path(
        "corp/list/",
        CorpListAPIView.as_view(),
        name="corp-list"
    ),
    # 특정 Corporation의 정보 조회
    path(
        "corp/<int:c_id>/",
        CorpDetailAPIView.as_view(),
        name="corp-detail"
    ),
    # Corporation 삭제
    path(
        "corp/<int:c_id>/delete/",
        CorpDeleteAPIView.as_view(),
        name="corp-delete"
    ),
