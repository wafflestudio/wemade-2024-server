...
class PersonCardChangeRequest(models.Model):
    ...
    person = models.ForeignKey(
        Person, on_delete=models.CASCADE, related_name="card_change_requests"
    )
    column = models.ForeignKey(
        PersonCardColumns, on_delete=models.CASCADE, related_name="change_requests"
    )
    ...
    supporting_material = models.CharField(null=True, blank=True)
