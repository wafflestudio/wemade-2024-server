...
class Person(models.Model):
    ...
    corporations = models.ManyToManyField(Corporation, related_name="corporation_persons", blank=True)  # 소속 법인
    teams = models.ManyToManyField(Team, related_name="team_persons", blank=True)  # 소속 팀

    roles = models.JSONField(null=True, blank=True)  # 역할 정보
